...
/* const updatedMoviesCards = moviesCards.map((cardElement) => {
  if (cardElement._id === newCard.movieId) {
...
/* function setLikeStatus(oldCard, newCard) {
  if (oldCard._id === newCard.movieId) {
    oldCard.isLiked = true;
    return oldCard;
  } else {
    return newCard;
  };
...
/* cardElement.movieId = newCard._id;
cardElement.like = !cardElement.like; */
